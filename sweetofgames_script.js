//var pacmanScore = 0;
//var bombermanScore = 1;
//var snakeScore = 3;
//document.getElementById("pacmanScore").innerHTML = pacmanScore;
//document.getElementById("bombermanScore").innerHTML = bombermanScore;
        ...
        dirs.forEach((dir) => {
            for (let i = 0; i < bomb.size; i++) {
                ...
                if (cell == types.softWall) {
                    bombermanScore = bombermanScore + 1;
                    document.getElementById("bombermanScore").innerHTML = bombermanScore;
                }
    ...
    snake.cells.forEach(function (cell, index) {
        ...
        for (var i = index + 1; i < snake.cells.length; i++) {
            ...
            if (cell.x === snake.cells[i].x && cell.y === snake.cells[i].y) {
                ...
                apple.x = getRandomInt(0, 25) * speed;
                apple.y = getRandomInt(0, 25) * speed;
            }
        }
    });
}
